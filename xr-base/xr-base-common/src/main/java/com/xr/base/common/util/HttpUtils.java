 ...
 * <b>time</b>: 2020-01-15 16:58:00 <br>
...
//      conn.getRequestProperty("Content-Type").contains("json")
      OutputStream outwritestream = conn.getOutputStream();
      outwritestream.write(JsonUtils.parseJson(params).getBytes(DEFAULT_CHARSET));
